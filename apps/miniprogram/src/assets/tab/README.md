...
| 文件名                 | 用途                | 状态      |
| ---------------------- | ------------------- | --------- |
| `home.png`             | 首页 - 未选中态     | ✅ 已生成 |
| `home-active.png`      | 首页 - 选中态       | ✅ 已生成 |
| `square.png`           | 灵感广场 - 未选中态 | ✅ 已生成 |
| `square-active.png`    | 灵感广场 - 选中态   | ✅ 已生成 |
| `benchmark.png`        | 对标解析 - 未选中态 | ✅ 已生成 |
| `benchmark-active.png` | 对标解析 - 选中态   | ✅ 已生成 |
| `mine.png`             | 我的 - 未选中态     | ✅ 已生成 |
| `mine-active.png`      | 我的 - 选中态       | ✅ 已生成 |
