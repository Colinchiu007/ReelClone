...
export default function BindMobileModal({ visible, onClose, onSuccess }: BindMobileModalProps) {
  ...
  return (
    <View className='bind-modal' onClick={onClose}>
      <View className='bind-modal__panel' onClick={handleStopPropagation}>
        <View className='bind-modal__head'>
          <Text className='bind-modal__title'>绑定手机号</Text>
          <Text className='bind-modal__close' onClick={onClose}>×</Text>
        </View>

        <View className='bind-modal__body'>
          {/* 手机号 */}
          <View className='bind-modal__field'>
            ...
            />
            {mobileError ? (
              <Text className='bind-modal__error'>{mobileError}</Text>
            ) : null}
          </View>
          ...
          <View className='bind-modal__field'>
            ...
            {codeError ? (
              <Text className='bind-modal__error'>{codeError}</Text>
            ) : null}
          </View>
        </View>

        <View className='bind-modal__footer'>
