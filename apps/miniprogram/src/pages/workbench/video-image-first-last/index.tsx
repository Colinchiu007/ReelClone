    ...
    <View className="video-fl-wb page-wrap">
      ...
      <View className="video-fl-wb__body">
        ...
        <View className="page-wrap__section">
          ...
          <MediaUploader type="image" maxCount={1} value={lastFrame} onChange={setLastFrame} />
        </View>

        {/* 模型选择 */}
        <View className="page-wrap__section">
          <Text className="page-wrap__label">模型</Text>
          <View className="video-fl-wb__select" onClick={() => setShowModelSheet(true)}>
        ...
        <View className="video-fl-wb__estimate">
          ...
          <Text className="video-fl-wb__estimate-value">{estimatedPoints} 积分</Text>
        </View>
